...
package me.nucleus.atom.module;
...
import me.nucleus.atom.util.ClassFinder;
import me.nucleus.atom.module.modules.ClickGUI;
...
public class ModuleManager
{
    ...
    public static void initialize() {
        ...
        AtomMod.log.info("Modules initialised");
    ...
    public static Module getModuleByNameUnsafe(final String name) {
        final Integer index = ModuleManager.lookup.get(name.toLowerCase());
        if (index == null) {
            return null;
        }
