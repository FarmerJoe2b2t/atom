...
@Info(name = "CrystalAura", category = Category.HIDDEN)
public class CrystalAura extends Module
{
    ...
    public void onUpdate() {
        ...
        if (this.explode.getValue() && crystal != null && CrystalAura.mc.field_71439_g.func_70032_d((Entity)crystal) <= this.range.getValue()) {
        ...
        if (this.players.getValue()) {
            entities.addAll((Collection<? extends Entity>)CrystalAura.mc.field_71441_e.field_73010_i.stream().filter(entityPlayer -> !Friends.isFriend(entityPlayer.func_70005_c_())).collect(Collectors.toList()));
        }
        final boolean b2;
        entities.addAll((Collection<? extends Entity>)CrystalAura.mc.field_71441_e.field_72996_f.stream().filter(entity -> {
        ...
        for (final Entity entity2 : entities) {
            if (entity2 != CrystalAura.mc.field_71439_g) {
                ...
                for (final BlockPos blockPos : blocks) {
                    ...
                    final double self = calculateDamage(blockPos.field_177962_a + 0.5, blockPos.field_177960_b + 1, blockPos.field_177961_c + 0.5, (Entity)CrystalAura.mc.field_71439_g);
                    if (self > d && d >= ((EntityLivingBase)entity2).func_110143_aJ()) {
                        continue;
                    }
                    if (self - 0.5 > CrystalAura.mc.field_71439_g.func_110143_aJ()) {
                        continue;
                    }
                    damage = d;
                    q = blockPos;
        ...
        if (this.place.getValue()) {
            ...
            this.lookAtPacket(q.field_177962_a + 0.5, q.field_177960_b - 0.5, q.field_177961_c + 0.5, (EntityPlayer)CrystalAura.mc.field_71439_g);
            final RayTraceResult result = CrystalAura.mc.field_71441_e.func_72933_a(new Vec3d(CrystalAura.mc.field_71439_g.field_70165_t, CrystalAura.mc.field_71439_g.field_70163_u + CrystalAura.mc.field_71439_g.func_70047_e(), CrystalAura.mc.field_71439_g.field_70161_v), new Vec3d(q.field_177962_a + 0.5, q.field_177960_b - 0.5, q.field_177961_c + 0.5));
            EnumFacing f;
            ...
            CrystalAura.mc.field_71439_g.field_71174_a.func_147297_a((Packet)new CPacketPlayerTryUseItemOnBlock(q, f, offhand ? EnumHand.OFF_HAND : EnumHand.MAIN_HAND, 0.0f, 0.0f, 0.0f));
        }
    ...
    public void onWorldRender(final RenderEvent event) {
        if (this.render != null) {
            ...
            if (this.renderEnt != null) {
                final Vec3d p = EntityUtil.getInterpolatedRenderPos(this.renderEnt, CrystalAura.mc.func_184121_ak());
                Tracers.drawLineFromPosToPos(this.render.field_177962_a - CrystalAura.mc.func_175598_ae().field_78725_b + 0.5, this.render.field_177960_b - CrystalAura.mc.func_175598_ae().field_78726_c + 1.0, this.render.field_177961_c - CrystalAura.mc.func_175598_ae().field_78723_d + 0.5, p.field_72450_a, p.field_72448_b, p.field_72449_c, this.renderEnt.func_70047_e(), 1.0f, 1.0f, 1.0f, 1.0f);
            }
        }
    }
