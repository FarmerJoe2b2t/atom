...
public class HelpCommand extends Command
{
    ...
    public void call(final String[] args) {
        if (args[0] == null) {
            Command.sendStringChatMessage(new String[] { "ATOM", "KAMI Blue v0.1", "commands&7 to view all available commands", "bind <module> <key>&7 to bind mods", "&7Press &r" + ModuleManager.getModuleByName("ClickGUI").getBindName() + "&7 to open GUI", "prefix <prefix>&r to change the command prefix.", "help <subjects:[subject]> &r for more help." });
        }
        else {
