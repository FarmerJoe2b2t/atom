...
package me.nucleus.atom.gui.rgui.component.use;

import me.nucleus.atom.gui.rgui.poof.use.Poof;
...
import me.nucleus.atom.gui.rgui.component.AbstractComponent;
    ...
    public InputField(final String text) {
        ...
        this.addRenderListener(new RenderListener() {
            ...
            public void onPostRender() {
                ...
                final boolean cursor = (int)((System.currentTimeMillis() - InputField.this.lastTypeMS) / 500L) % 2 == 0 && InputField.this.isFocused();
                int x = 0;
                int i = 0;
